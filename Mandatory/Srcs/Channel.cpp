...
Channel::Channel() : topic(""), maxUsers(0), inviteOnly(false), privateTopic(false), password(""), name("") {}

Channel::Channel(std::string name) : topic(""), maxUsers(0), inviteOnly(false), privateTopic(false), password(""), name(name) {}
